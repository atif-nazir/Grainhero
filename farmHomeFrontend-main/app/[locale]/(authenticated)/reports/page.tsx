...
export default function ReportsPage() {
  ...
  const handleExportAll = () => {
    window.open(`${config.backendUrl}/dashboard/export-report?type=summary&format=pdf`, "_blank", "noopener,noreferrer")
  }

  // Calculate derived metrics
  const riskScore = 0 // Placeholder since insurance data is removed

  const siloUtilization = overview?.ops.total_silos
    ? Math.round((overview.ops.active_silos / overview.ops.total_silos) * 100)
    : 0
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-blue-900">{overview?.ops.total_batches ?? 0}</div>
                  <p className="text-xs text-blue-600 mt-1">Operations across silos</p>
                </CardContent>
              </Card>
              ...
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-emerald-100/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-emerald-600 mt-1">Subscription revenue (period)</p>
                </CardContent>
              </Card>
              ...
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-purple-900">{overview?.payments.active ?? 0}</div>
                  <p className="text-xs text-purple-600 mt-1">Active subscriptions</p>
                </CardContent>
              </Card>
              ...
              <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-amber-50 to-amber-100/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-amber-900">{riskScore}%</div>
                  <p className="text-xs text-amber-600 mt-1">Approved claims ratio</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{overview?.ops.total_silos || 0}</p>
                    </div>
              ...
              <Card className="border shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">Active Silos</p>
                      <p className="text-2xl font-bold">{overview?.ops.active_silos || 0}</p>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{overview?.ops.total_batches || 0}</p>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{overview?.payments.past_due || 0}</p>
                    </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700" onClick={() => handleDownloadReport('Grain Batch', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Grain Batch', 'csv')}>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700" onClick={() => handleDownloadReport('Silo Performance', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Silo Performance', 'csv')}>
                      <FileText className="h-4 w-4" />
                      CSV
                    </Button>
                  </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700" onClick={() => handleDownloadReport('Revenue', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Revenue', 'csv')}>
                      <FileText className="h-4 w-4" />
                      CSV
                    </Button>
                  </div>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700" onClick={() => handleDownloadReport('Performance', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Performance', 'csv')}>
                      <FileText className="h-4 w-4" />
                      CSV
                    </Button>
                  </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700" onClick={() => handleDownloadReport('Compliance', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Compliance', 'csv')}>
                      <FileText className="h-4 w-4" />
                      CSV
                    </Button>
                  </div>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex gap-2">
                    <Button className="flex-1 gap-2 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700" onClick={() => handleDownloadReport('Traceability', 'pdf')}>
                      <Download className="h-4 w-4" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="gap-2" onClick={() => handleDownloadReport('Traceability', 'csv')}>
                      <FileText className="h-4 w-4" />
                      CSV
                    </Button>
                  </div>
