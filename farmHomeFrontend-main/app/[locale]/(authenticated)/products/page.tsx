...
// import { useCart, Product as BaseProduct } from "@/components/CartProvider";
...
//   type ExtendedProduct = BaseProduct & { location?: string; ratings?: Array<{ value: number; comment?: string; date?: string }>; tags?: string[] };
...
//   const handleEditClick = (product: BaseProduct & Record<string, any>) => {
//     setEditForm({
//       _id: product._id,
//       name: product.name,
...
//                       (() => {
//                         const avg = product.ratings.reduce((sum: number, r: { value: number }) => sum + r.value, 0) / product.ratings.length;
//                         return (
